...
def main() -> None:
    ...
    model_path = OUT_DIR / "transformer_5day_sp500_model.pt"
    scaler_path = OUT_DIR / "transformer_5day_sp500_scaler.json"
    metrics_path = OUT_DIR / "transformer_5day_sp500_metrics.json"
    symbol_summary_path = OUT_DIR / "transformer_5day_sp500_symbol_summary.json"
    config_path = OUT_DIR / "transformer_5day_sp500_config.json"
