...
- A single resumable Alpha Vantage `SPLITS` archive is active for those 308 flagged symbols at `D:\AlientAI\Data\AlphaVantage_2026\russell_split_history_2026`, with a 0.75-second delay. Do not start another copy. On completion, compare source dates to review flags only; do not adjust raw candles or retrain until a separate historical-universe design is available.
