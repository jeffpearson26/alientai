...
Generated: 2026-08-12 06:36 Pacific (intraday readiness pass)
...
| 7 | Schwab late-entry 60-minute calls | 17 symbols; 09:35 to 10:30; Alpha prior technical/calls + Schwab 09:25 premarket | Untouched: 28 trades, 57.14% wins, +0.6325% mean, +11.2514% compounded, -5.7230% drawdown. Prospective: 4 trades across 2 dates, 50% wins, +1.0013% mean net, +1.9507% compounded, -1.4876% drawdown. | **AUGUST 12 ABSTENTION; PRIOR OUTCOMES COMPLETE** | No August 12 observation was written: exact 17-symbol Alpha technical and call-history panels for the August 11 prior session were unavailable, and no current-session Schwab snapshot existed before the 09:35 ET entry. Latest preserved inputs remain August 5. The entry is now observable and may not be backfilled. |
| 8 | Schwab late-entry 60-minute premarket | Same 17-symbol 09:35 program without call feature family | Untouched: 56 trades, 51.79% wins, +0.3895% mean, +4.6607% compounded, -7.1860% drawdown. Prospective: 8 trades across 2 dates, 75% wins, +2.0367% mean net, +4.0593% compounded, -0.3193% drawdown. | **AUGUST 12 ABSTENTION; PRIOR OUTCOMES COMPLETE** | The shared fail-closed readiness gate blocked this model before scoring for the same stale prior-session inputs and absent pre-entry Schwab snapshot. No row was appended; the two-date prospective cohort remains too small for promotion. |
