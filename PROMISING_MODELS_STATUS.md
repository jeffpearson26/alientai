...
Generated: 2026-08-04 08:05 Pacific  
...
|---:|---|---|---|---|---|
| 1 | Technical context + unusual calls | Natural universe; 5 sessions; technical score then unusual call buying | Prospective: 5 signals, 80% wins, +1.8944% mean, +3.0803% median. Historical fixed slices were positive at three chronological splits. | **BLOCKED / MUST RECOVER** | Only one prospective decision date. New exact nonempty option chains and ten-prior-call history have not produced another complete dated payload. |
| 2 | Nasdaq-101 baseline | 101 symbols; 5 sessions; technical | Historical untouched top 0.25%: 20 rows, 70% >=10% winners. First completed prospective date: 2 signals, 100% wins, +6.7067% mean. | **ACTIVE EVIDENCE, ROLLING-JOURNAL GAP** | First outcomes completed, but dedicated journal latest decision date is still 2026-07-27. It must attempt a new frozen observation every eligible day. |
| 3 | Nasdaq-101 QQQ-relative | 101 symbols; 5 sessions; technical + QQQ-relative context | Historical untouched top 0.10%: 8/8 >=10% winners; top 0.25%: 65%. First prospective date: 2 signals, 50% wins, +2.3750% mean. | **ACTIVE EVIDENCE, ROLLING-JOURNAL GAP** | Same missing daily advancement as baseline; August 3 competition picks exist but do not replace the dedicated journal. |
...
| 6 | Schwab late-entry 60-minute calls | 17 symbols; 09:35 to 10:30; Alpha prior technical/calls + Schwab 09:25 premarket | Untouched: 28 trades, 57.14% wins, +0.6325% mean, +11.2514% compounded, -5.7230% drawdown. | **READY FOR NEXT VALID MORNING, MISSED 2026-08-04** | August 3 technical/call prerequisites were not prepared. Readiness auditor and exact-prior-date rejection are now implemented; next attempt must pass before 09:30 ET. |
| 7 | Schwab late-entry 60-minute premarket | Same 17-symbol 09:35 program without call feature family | Untouched: 56 trades, 51.79% wins, +0.3895% mean, +4.6607% compounded, -7.1860% drawdown. | **READY FOR NEXT VALID MORNING, MISSED 2026-08-04** | Same repaired prerequisite failure as the calls variant. |
| 8 | AI/semi one-session narrative earnings context | 17 symbols; 1 session; technical + premarket + point-in-time earnings context | Exploratory frozen comparison: 37 selections, 62.16% wins, +0.7476% mean, +0.5398% median. | **FROZEN BUT NO PROSPECTIVE OBSERVATION YET** | No complete genuinely future all-17 panel was journaled before cutoff. Must wait for a complete pre-entry panel; no backfill. |
| 9 | AI/semi technical + premarket | 17 symbols; 5 sessions | Validation-locked historical test: 31 selections, +1.7260% mean, -0.0638% median, 48.39% wins. Separate journal has 4 pending observations across 2 dates. | **ACTIVE / OUTCOMES PENDING, DAILY-GAP AUDIT NEEDED** | Existing observations are pending, but latest decision date is 2026-07-31; pending horizons must not suppress new eligible observations. |
| 10 | Nasdaq-80 champion | 80 symbols; 5 sessions; QQQ-context technical | Corrected historical test: 12 trades, +2.8700% mean, +1.6163% median, 58.33% wins. | **ACTIVE / ONE OUTCOME BLOCKED** | One PLTR observation is pending candle coverage; journal latest date is 2026-07-30 and needs daily advancement. |
