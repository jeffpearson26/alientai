...
def main() -> None:
    ...
    parser.add_argument("--non-overlapping-calendar-days", type=int, default=4)
    ...
    model_path = OUT_DIR / "transformer_2day_russell_model.pt"
    scaler_path = OUT_DIR / "transformer_2day_russell_scaler.json"
    metrics_path = OUT_DIR / "transformer_2day_russell_metrics.json"
    symbol_summary_path = OUT_DIR / "transformer_2day_russell_symbol_summary.json"
    config_path = OUT_DIR / "transformer_2day_russell_config.json"
