...
6. Monitor the single active annual Alpha Vantage `LISTING_STATUS` archive at `D:\AlientAI\Data\AlphaVantage_2026\listing_status_annual_2010_2026`. It records active US listings at each June 30 from 2010–2026 to support later survivorship checks, but does not identify Russell membership.
...
- 2026-07-23: Extended and tested the credential-safe Alpha Vantage reference collector for dated `LISTING_STATUS` snapshots. Started a single archive of active listings at June 30 for 2010–2026 in `D:\AlientAI\Data\AlphaVantage_2026\listing_status_annual_2010_2026`, with a 0.75-second delay. These records can support later active/delisted survivorship checks; they neither establish Russell membership nor trigger training.
