...
5. Monitor the single active `SPLITS` archive for the 308 Russell split-ratio review symbols at `D:\AlientAI\Data\AlphaVantage_2026\russell_split_history_2026`. After it completes, compare source-recorded split dates only to the review flags; do not edit source candles, labels, or models.
