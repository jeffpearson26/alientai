...
BUILD = "ALIENTAI_V2_TRANSFORMER_20DAY_DAILY_TRAINER_V1"
...
def main() -> None:
    ...
    model_path = OUT_DIR / "transformer_20day_model.pt"
    scaler_path = OUT_DIR / "transformer_20day_scaler.json"
    metrics_path = OUT_DIR / "transformer_20day_metrics.json"
    symbol_summary_path = OUT_DIR / "transformer_20day_symbol_summary.json"
    config_path = OUT_DIR / "transformer_20day_config.json"
